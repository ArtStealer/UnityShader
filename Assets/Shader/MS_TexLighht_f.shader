      ...
      {    
         ...
         float4 frag(vertexOutput input) : COLOR
         {
            ...
            else // light source on the right side
            {
               ...
               specularReflection = attenuation * _LightColor0.rgb * _SpecColor.rgb * (1.0 - textureColor.a) * pow(max(0.0, dot( reflect(-lightDirection, normalDirection), viewDirection)), _Shininess);
            }
